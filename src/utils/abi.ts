export const ABI = {
  ...
  exposed_functions: [
    ...
    },
    {
      ...
      params: ["&signer", "0x1::object::Object<0x1::object::ObjectCore>", "u64"],
      return: [],
    },
    {
  ...
  structs: [
    ...
    },
    {
      ...
      abilities: ["key"],
      generic_type_params: [],
      fields: [{ name: "listings", type: "0x1::smart_vector::SmartVector<address>" }],
    },
    {
      name: "Sellers",
      is_native: false,
      abilities: ["key"],
      generic_type_params: [],
      fields: [{ name: "addresses", type: "0x1::smart_vector::SmartVector<address>" }],
    },
  ],
} as const;
